...
version = {}
with io.open(os.path.join(base_dir, "clask/version.py"), 'r') as f:
    exec(f.read(), version)
...
setup(
    ...
    description="a http client based on requests just like Flask",

    keywords='clask flask requests',
    author='Peng Shiyu',
    author_email='pengshiyuyx@gmail.com',
    license='MIT',
    url="https://github.com/mouday/Clask",
